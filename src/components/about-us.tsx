      ...
      >
        <motion.div className="lg:w-1/2" variants={cardVariants}>
          ...
          <p className="text-md text-white mb-6 font-body md:pr-16">
              ...
              walking, daily check-ins, and feeding visits — all tailored to fit
              your schedule and your pet&rsquo;s routine.
              <br />
              <br />
              As a registered and insured LLC, we are committed to providing
              safe, reliable, and loving care backed by years of experience and
              24/7 availability. Whether you&apos;re at work, on vacation, or
              simply need a helping hand, you can count on us to treat your pets
              like family.
              <br />
              <br />
              We make booking simple with online reservations, instant
              confirmations, and even Google sign-in for fast access. Your peace
              of mind is our priority — and your pet&rsquo;s happiness is our
              mission.
              <br />
              <br />
