      ...
      <div className="min-h-screen bg-black max-w-[90%] lg:max-w-6xl 2xl:max-w-7xl mx-auto mt-24 text-white">
        <div className="h-[300px] flex flex-col items-center justify-center bg-golden rounded-lg mb-4">
          ...
          <h1 className="text-3xl text-black mt-4 font-semibold">
            Pet Sitting ($65 per day or night)
          </h1>
        </div>
        ...
        <div className="container mx-auto py-8 flex flex-col md:flex-row justify-between gap-10">
          ...
          <div className="md:w-[70%] rounded shadow">
            ...
            <p className="text-white mb-4">
              Going away for the day or need overnight care? Our Pet Sitting
              service has you covered for $65 per day or night. This includes
              comprehensive care and supervision for your pet in the comfort of
              their own home. We stick to your pet&apos;s routine so they stay
              comfortable and stress-free while you&apos;re away. Pet sitting
              typically includes:
            </p>
            <div className="mt-6">
              ...
              <ul className="list-disc list-inside text-gray-300 mt-2">
                <li className="py-2 ">
                  <strong>Feeding & Fresh Water:</strong> We&apos;ll follow your
                  instructions to feed your pet on schedule and keep their water
                  bowl clean and filled.
                </li>
                <li className="py-2 ">
                  <strong>Playtime & Exercise:</strong> Plenty of play, cuddles,
                  and exercise to keep your pet happy and active. We&apos;ll
                  play their favourite games and go on potty breaks as needed.
                </li>
                <li className="py-2 ">
                  <strong>Companionship & Supervision:</strong> Your pet
                  won&apos;t feel lonely - we provide attentive companionship
                  and keep a close eye on their well-being throughout the visit.
                </li>
                <li className="py-2 ">
                  <strong>Home Care:</strong> Basic home tasks like bringing in
                  mail or watering a pet&apos;s plants can be done upon request,
                  helping your home look “lived in” and secure.
                </li>
              </ul>
            </div>
            <p className="mt-4 text-gray-300">
              Whether it&apos;s during the day or overnight, we ensure your pet
              is safe, comfortable, and loved. You&apos;ll get updates (photos
              or texts, if you&apos;d like) so you can see how your furry friend
              is doing. Rate: $65 covers a full day or an overnight period of
              care.
            </p>
            <div className="mt-6">
