      ...
      <div className="min-h-screen bg-black max-w-[90%] lg:max-w-6xl 2xl:max-w-7xl mx-auto mt-24 text-white">
        ...
        <div className="container mx-auto py-8 flex flex-col md:flex-row justify-between gap-10">
          ...
          <div className="md:w-[70%] rounded shadow">
            <img
              src="/images/pet-drop-in-visit.jpg"
            ...
            <p className="text-white mb-4">
              Our Drop-In Visit service provides care and attention for your pet
              while you&apos;re away. We will check on your pet, refresh their
              food and water, and ensure everything is okay in your home. Each
              visit lasts 15-30 minutes, offering comfort and companionship for
              your pet.
            </p>
            <div className="mt-6">
              ...
              <ul className="list-disc list-inside text-gray-300 mt-2">
                <li className="py-2 ">
                  Ensuring your pet stays nourished and hydrated.
                </li>
                <li className="py-2 ">
                  Scooping litter or letting pet outside.
                </li>
                <li className="py-2 ">
                  Making sure your pet is safe, healthy, and comfortable.
                </li>
                <li className="py-2 ">
                  Spending quality time with your pet to keep them happy.
                </li>
                <li className="py-2 ">
                  A quick scan to ensure everything is in order.
                </li>
              </ul>
            </div>
            ...
            <div className="mt-6">
              ...
              <p>
                ...
                you can schedule pet care with confidence and ease. Here&apos;s
                a step-by-step guide on how to book a service with us:
              </p>
              <ul className="list-disc list-inside text-gray-300 mt-2">
                <li className="py-2 ">
                ...
                <li className="py-2 ">
                  ...
                  instructions or preferences (for example, “30-minute walk
                  around 3 PM” or “overnight sit on Friday night”)
                </li>
                <li className="py-2 ">
                  <strong>Confirm Your Booking:</strong> Once you&apos;ve
                  entered the details, submit your booking request. You&apos;ll
                  receive an email confirmation shortly after, summarizing your
                  booking details - including the service type, date/time,
                  price, and any instructions you provided. Please check that
                  everything is correct. If you notice something off, just let
                ...
                <li className="py-2 ">
                  ...
                  meet-and-greet before the service, especially for first-time
                  clients or pets with special needs. On the day of service,
                  simply relax - we&apos;ll show up as scheduled and take great
                  care of your pet! During longer bookings (like full-day sits
                  or multiple-day care), we can send periodic updates and photos
              ...
              <p className="mt-3">
                ...
                email (see the Contact & Support section below) if you want to
                discuss your pet&apos;s needs in detail, or if you&apos;d like
                to meet the caregiver (Sebastien) beforehand. We want you to
                feel completely comfortable, so don&apos;t hesitate to reach out
                at any stage of the booking process. Our system is designed to
                be hassle-free: Google login makes signing in easy, and email
                confirmations provide a clear record of your bookings. Payments
                for services can be arranged securely after booking confirmation
                (we&apos;ll provide details on payment methods in the
                confirmation email). Once everything is set, you can look
                forward to top-notch pet care and peace of mind!
              </p>
            </div>
          </div>
